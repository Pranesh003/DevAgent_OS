...
export const useAgentStore = create<AgentSessionState>((set) => ({
  ...
  reset: () => set({ sessionId: null, status: 'idle', currentPhase: '', iteration: 0, messages: [], codeFiles: [], documentation: {}, architecture: {}, debugOutput: {}, tests: [], critiqueScore: null, sessionStartTime: null }),
}));
