  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
      ...
      >
        ...
        <Link to="/dashboard/workspace" className="btn btn-primary">
          + New Project
        </Link>
      </motion.div>
      ...
      {loading ? (
        ...
        <div className="card" style={{ textAlign: 'center', padding: '60px 20px' }}>
          ...
          <Link to="/dashboard/workspace" className="btn btn-primary">Go to Workspace</Link>
        </div>
      ) : (
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 16, borderTop: '1px solid var(--bg-border)' }}>
                ...
                <Link 
                  to={`/dashboard/workspace?projectId=${project._id}`}
